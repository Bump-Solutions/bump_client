  ...
  return (
    <div className='product__price-tag'>
      ...
      <div className='product__price__infobox'>
        <p>
          Az itt feltüntetett ár <b>tájékoztató</b> jellegű. A pontos végleges
          összegről érdeklődj az eladónál. <br />A tételek ára a termék
          állapotától, méretétől és egyéb jellemzőitől függően eltérhet.
        </p>
